...
function App() {
  ...
  useEffect(() => {
    ...
    initGSAPVideo(gsap, {
      vidSelector: '#video-2-mobile', trigger: '.video-2-section-mobile', pin: true, end: 'bottom bottom', scrub: 2,
      onLeave: () => {
    ...
    initGSAPVideo(gsap, {
      vidSelector: '#video-sun-mobile', trigger: '.video-sun-mobile-section', pin: true, end: 'bottom bottom', scrub: 2,
      onLeave: () => {
    ...
    initGSAPVideo(gsap, {
      vidSelector: '#video-4-mobile', trigger: '.video-4-section-mobile', pin: true, end: 'bottom bottom', scrub: 2,
      onLeave: () => {
